...
PIPX_TOOLS = {
    "ansible-core": "IT automation platform",
    "bump2version": "Version-bump your software with a single command",
    "cambrinary": "Cambridge dictionary lookup tool (alias: define)",
    ...
    "django-lint": "Check Django code for common errors",
    "django-upgrade": "Upgrade Django projects to newer versions",
    "edir": "Directory editor for the terminal",
    ...
    "isort": "Library to sort Python imports",
    ...
    "linode-cli": "CLI for Linode cloud services",
    "locust": "Scalable user load testing tool",
    "lyrics-in-terminal": "Display lyrics in the terminal",
    "mammoth": "Convert Word documents to HTML",
    "mansnip-kristopolous": "Extract code snippets from man pages",
    ...
    "pip-autoremove": "Remove packages and their unused dependencies",
    "pip-deptree": "Display dependency tree of installed Python packages",
    "pip-env": "Python development workflow tool",
    ...
    "pip-upgrader": "Automatically upgrade pip packages",
    ...
    "pz": "Python package size analyzer",
    "pyupgrade": "Tool to upgrade syntax to newer Python versions",
    "rainbow": "Colorize text with ANSI escape codes",
    "rawr-cli": "CLI tool for working with RAWR files",
    "rbtools": "CLI for code review workflows",
    "refurb": "Modern Python code formatter",
    ...
    "spleeter": "Music source separation tool",
    ...
    "tvnamer": "TV series renamer",
    "twine": "Utilities for interacting with PyPI",
    "updatable": "Check for outdated dependencies",
